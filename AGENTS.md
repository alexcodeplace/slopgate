...
Specification, CI, architecture policy/guard, manifests/lockfiles, rules and baseline/suppression policy are orchestrator-owned. Change those only with explicit orchestrator authorization for the exact files. Owner-authorized autonomous review and merge are permitted under ADR 0004 after verified CI. Record review findings; do not manufacture independent approvals. Do not use `--no-verify`, force-push, stash/reset another person's work, bypass required checks, modify hosting protections without explicit owner authorization, or touch sibling worktrees. Do not inspect Fabro or Factory.
