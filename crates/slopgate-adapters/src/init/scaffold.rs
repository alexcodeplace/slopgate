...
pub fn merge_agent_hooks_file(
    ...
    slopgate_core::install::agent_hooks::merge_hooks(file_path, engine_root)
...
pub fn merge_settings_json(
    ...
    let result = slopgate_core::install::agent_hooks::remove_hooks(&settings_path, engine_root)?;
